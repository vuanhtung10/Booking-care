...
class ManageSchedule extends Component {
    ...
    componentDidUpdate(prveProps, prevState, snapshot) {
        if (prveProps.allDoctors !== this.props.allDoctors) {
            let dataSelect = this.buildDataInputSelect(this.props.allDoctors);
            this.setState({
                listDoctors: dataSelect,
            });
        }
        if (prveProps.allScheduleTime !== this.props.allScheduleTime) {
        ...
        // if (prveProps.language !== this.props.language) {
        //     let dataSelect = this.buildDataInputSelect(this.props.allDoctors);
        //     this.setState({
        //         listDoctors: dataSelect,
        //     });
    ...
    buildDataInputSelect = (inputData) => {
        ...
        if (inputData && inputData.length > 0) {
            let result = inputData.map((item, index) => {
                let object = {};
