...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevSate, snapshot) {
        if (prevProps.genderRedux !== this.props.genderRedux) {
            ...
            console.log("arrGenders", arrGenders);
            this.setState({
    ...
    handleOnchangeImage = async (event) => {
        ...
        if (file) {
            ...
            console.log("hoi dan itbase64 image:", base64);
            let objectUrl = URL.createObjectURL(file);
            console.log("aaaaaaa", file);
            console.log("bbbbbbbbb", objectUrl);
            this.setState({
    ...
    handleEditUserFromParent = (user) => {
        console.log("hoi dan it check handleeditiser from parent", user);
        let imageBase64 = "";
        if (user.image) {
